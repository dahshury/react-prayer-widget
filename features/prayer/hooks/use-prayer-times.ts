...
import { useGeolocationPermission } from "@/features/settings/hooks/use-geolocation-permission";
import { useSettingsPersistence } from "@/features/settings/hooks/use-settings-persistence";
...
import { useLoadPrayerTimes } from "./use-load-prayer-times";
