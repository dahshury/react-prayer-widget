								...
								{status === "idle" || status === "dragging" ? (
									...
									>
										...
										<button
											...
											className={cn(
												"flex items-center justify-center gap-2 rounded-lg bg-gray-100 dark:bg-white/10 px-3 py-2 text-sm font-semibold text-gray-900 dark:text-white transition-all duration-200 hover:bg-gray-200 dark:hover:bg-white/20 group",
