...
export const ColorPicker = ({
	...
	const [saturation, setSaturation] = useState<number>(
		initial.saturationl() || 100,
	);
	const [lightness, setLightness] = useState<number>(initial.lightness() || 50);
	const [alpha, setAlpha] = useState<number>(
		Math.round((initial.alpha() ?? 1) * 100),
	);
	...
	useEffect(() => {
		...
		try {
			...
			const nextAlpha = Math.round((c.alpha() ?? 1) * 100);
			setHue(nextHue);
